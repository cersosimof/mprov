...
public class Constantes {
    ...
    // ADMIN KC
    public static final String URL_TOKEN_KC = "http://192.168.0.163:8080/auth/realms/master/protocol/openid-connect/token";
    public static final String CONTENT_TYPE_KC = "application/x-www-form-urlencoded";
    public static final String USERNAME_KC = "cersosimof";
    public static final String PASSWORD_KC = "fender1";
    public static final String CLIENT_SECRET_KC = "a5a27889-3927-4f5d-9618-6bf26d4cc571";
    ...
    // PROVEEDORES KC
    public static final String CLIENT_SECRET_PROVEEDORES = "ec737619-eb54-4f59-aeba-0be6fc191470";
    ...
    public static final String URL_TOKEN_PROVEEDORES = "http://192.168.0.163:8080/auth/realms/prueba/protocol/openid-connect/token";
    public static final String URL_CERRAR_SESION = "http://192.168.0.163:8080/auth/realms/prueba/protocol/openid-connect/logout";
    public static final String URL_REFRESH_TOKEN = "http://192.168.0.163:8080/auth/realms/prueba/protocol/openid-connect/token";
